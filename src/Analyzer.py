...
class BiologicalSystemAnalyzer:
    ...
    def find_ees_protocol(self, target_amplitude=15, target_period=2, 
        ...
        target_period : float
            Target period of oscillation (in seconds)
        update_interval : float
            Update interval for controller (in ms)
        prediction_horizon : float
            Prediction horizon for controller (in ms)
